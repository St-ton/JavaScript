...
let resultSum = products.reduce(
  (sum, elem) => sum + elem.marks.reduce((sum1, elem1) => sum1 + elem1),
  0
);
console.log(resultSum);

// Вариант Анатолия
// let resultSum = products.reduce((sum, elem) =>  sum + elem.marks.reduce((sum1, elem1)=> sum1+elem1), 0);
