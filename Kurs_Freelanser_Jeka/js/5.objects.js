...
// ключи
// console.log(key + ' - ' + userInfo[key]); // name, age, address
// значения ключей
...
// function UserInfo(name, age, count) {
...
// console.log(new UserInfo('Вася', 30, 5));
// console.log(new UserInfo('Лена', 25, 4));
// console.log(new UserInfo('Лена', 20, 3));
// console.log(new UserInfo('Лена', 35, 4));
